...
def main(plot: bool, write_seq: bool, seq_filename: str = "256_3d_t1_mprage_pypulseq.seq"):
    ...
    # Delays
    # =========
    TE, TI, TR, T_recovery = 4e-3, 140e-3, 10e-3, 1e-3  # dt 90-mid_adc, dt inversion_180-first_90, dt echoes 90-90
    delay_TE = (
    ...
    # ======
    if plot:
        seq.plot(time_range=[0,TI + TR + 2e-3], label="PAR")

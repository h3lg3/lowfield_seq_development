...
def constructor(
    ...
    pe1 = np.arange(n_enc_pe1) - (n_enc_pe1) / 2    # modified np.arange(n_enc_pe1) - (n_enc_pe1 - 1) / 2 
    pe2 = np.arange(n_enc_pe2) - (n_enc_pe2) / 2    # modified np.arange(n_enc_pe1) - (n_enc_pe1 - 1) / 2 
    ...
    if trajectory is Trajectory.INOUT or trajectory is Trajectory.OUTIN:
